    ...
    const firebaseConfig = {
        ...
        apiKey: "AIzaSyC6txzAYdD1uitJTfhDVeI9OPQX71TybxQ",
        authDomain: "my-project-82b3b.firebaseapp.com",
        projectId: "my-project-82b3b",
        storageBucket: "my-project-82b3b.firebasestorage.app",
        messagingSenderId: "352419793819",
        appId: "1:352419793819:web:c121b75822e43b934a6f3e",
        measurementId: "G-2MHCZ3WL5F"
    };
   ...
   document.addEventListener('DOMContentLoaded', () => {
                                ...
                                <form id="transaction-form">
                                    <div class="form-row">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-input" name="amount" step="0.01" placeholder="0.00" required>
                                        </div>
        ...
        return `
             <div class="space-y-4">
                 <div class="flex justify-between items-center">
                     ...
                     <button class="btn btn-primary" id="toggle-goal-form-btn">
                 ...
                 <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div class="stat-card"><div class="stat-value">${totalGoals} เป้าหมาย</div>
                        <div class="stat-label">เป้าหมายทั้งหมด</div>
                    </div>
                    <div class="stat-card"><div class="stat-value stat-positive">${completedGoals} เป้าหมาย</div>
                        <div class="stat-label">เป้าหมายที่สำเร็จ</div>
                    </div>
                    <div class="stat-card"><div class="stat-value">${formatCurrency(totalSavings)} ฿</div>
                        <div class="stat-label">เงินออมรวม</div>
                    </div>
                 </div>
                     ...
                     <div class="card-content">
                         <form id="goal-form">
                             <div class="form-row"><div class="form-group">
                                ...
                                <input type="text" class="form-input" name="title" placeholder="เช่น ซื้อบ้าน, เที่ยวญี่ปุ่น" required>
                            </div>
                            <div class="form-group">
                                <label class="form-label">จำนวนเงินเป้าหมาย (บาท)</label>
                                <input type="number" class="form-input" name="targetAmount" placeholder="0" required>
                            </div>
                            <div class="form-group">
                                <label class="form-label">หมวดหมู่</label>
                                <select class="form-select" name="category" required>
                                    <option value="">เลือกหมวดหมู่</option>
                                    <option value="ซื้อบ้าน">ซื้อบ้าน</option>
                                    <option value="ซื้อรถ">ซื้อรถ</option>
                            ...
                            <div class="form-group">
                             ...
                             <div class="form-group"><label class="form-label">รายละเอียด (ไม่บังคับ)</label>
                                <textarea class="form-textarea" name="description" placeholder="รายละเอียดเป้าหมาย..."></textarea>
                             </div>
                             <div class="flex gap-2"><button type="submit" class="btn btn-primary">สร้างเป้าหมาย</button>
                                <button type="button" class="btn btn-outline" id="cancel-goal-form-btn">ยกเลิก</button>
                             </div>
                         </form>
                    </div>
                 </div>
    ...
    function initGoalsPage() {
        ...
        .addEventListener('click', () => formCard.style.display = 'block');
        
        document.getElementById('cancel-goal-form-btn')
        .addEventListener('click', () => formCard.style.display = 'none');
    ...
    function renderProgressPage() {
        ...
        <div class="space-y-4">
            ...
            <!-- การ์ด: การใช้จ่ายตามหมวดหมู่ -->
            <div class="card">
                <div class="card-header">
                    <div class="card-title">การใช้จ่ายตามหมวดหมู่</div>
                </div>
                <div class="card-content">
                    <div class="chart-container">
    ...
    function initIncomeExpenseChart() {
        ...
        new Chart(ctx, {
            type: 'line',
            data: { labels: labels, 
                    datasets: [ { label: 'รายรับ', data: incomeData, borderColor: '#10b981', fill: false }, 
                    { label: 'รายจ่าย', data: expenseData, borderColor: '#ef4444', fill: false } ] 
                  },
